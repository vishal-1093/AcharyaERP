...
const ContraVoucher = lazy(() =>
  import("./pages/forms/accountMaster/ContraVoucher.jsx")
);
...
const NewAdmissionsDueReport = lazy(() => import("./containers/indeces/newAdmissionsDueReport/newAdmissionDueReportIndex.jsx"));
        ...
        >
          ...
          <>
            <Route
              exact
              path={"/Feepayment"}
              element={<Navigate replace to="/Feepayment/Miscellanous" />}
            />
