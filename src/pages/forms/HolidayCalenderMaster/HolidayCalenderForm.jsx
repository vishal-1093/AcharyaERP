...
function HolidayCalenderForm() {
  ...
  useEffect(() => {
    if (
      pathname.toLowerCase() === "/holidaycalendermaster/holidaycalender/new"
    ) {
      setIsNew(true);
      setCrumbs([
        { name: "Holiday Calender Master", link: "/HolidayCalenderMaster" },
  ...
  const getHolidayCalenderData = async () => {
    await axios
      ...
      .then((res) => {
        ...
        setCrumbs([
          { name: "HolidayCalenderMaster", link: "/HolidayCalenderMaster" },
  ...
  const handleCreate = async () => {
    if (!requiredFieldsValid()) {
      ...
      temp.leave_id = holidayTypeOptionsOne
        ...
        .toString();
      // temp.fromDate = convertDateToString(values.date);
      // temp.leave_id = values.holidayTypeId.toString();
      ...
      await axios
        ...
        .then((res) => {
          ...
          if (res.status === 200 || res.status === 201) {
            navigate("/HolidayCalenderMaster", { replace: true });
            setAlertMessage({
              severity: "success",
