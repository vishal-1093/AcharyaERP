...
function CourseAssignmentEmployee() {
  ...
  useEffect(() => {
    if (pathname.toLowerCase() === "/courseassignmentemployee") {
      setIsNew(true);
      setCrumbs([
        {
          name: "CourseAssignmentEmployeeIndex",
  ...
  const getCourseAssignmentData = async () => {
    await axios
      .get(`/api/academic/CourseAssignmentEmployee/${id}`)
      .then((res) => {
        setValues({
        ...
        setCourseAssignId(res.data.data.course_assignment_employee_id);
        setCrumbs([
          {
            name: "CourseAssignmentEmployeeIndex",
            link: "/CourseAssignmentEmployeeIndex",
  ...
  const handleCreate = async () => {
    if (!requiredFieldsValid()) {
      ...
      temp.remark = values.remarks;

      await axios
        .post(`/api/academic/saveCourseAssignmentEmployee`, temp)
        .then((res) => {
          setLoading(false);
          setAlertMessage({
            severity: "success",
  ...
  const handleUpdate = async () => {
    if (!requiredFieldsValid()) {
      ...
      const temp = {};
      temp.active = true;
      temp.course_assignment_employee_id = courseAssignId;
      temp.user_id = values.userId;
      temp.course_id = values.courseId;
      temp.remark = values.remarks;

      await axios
        .put(`/api/academic/updateCourseAssignmentEmployee/${id}`, temp)
        .then((res) => {
...
export default CourseAssignmentEmployee;
