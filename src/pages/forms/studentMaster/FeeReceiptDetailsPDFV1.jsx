  ...
  return (
      ...
      >
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end", gap: 2, mb: 2 }}>
          ...
          <Box sx={{ mt: 3 }}>
              ...
              <Grid item xs={4}>
              <Typography variant="body1"><strong>Name: </strong>{studentData?.student_name}</Typography>
            </Grid>
            <Grid item xs={4}>
              <Typography variant="body1"><strong>Receipt No.:</strong> {feeReceipt}</Typography>
            </Grid>
            <Grid item xs={4}>
            ...
            <Grid item xs={4}>
              <Typography variant="body1"><strong>Fee Category:</strong> {email?.fee_template_name ? email?.fee_template_name : "NA"}</Typography>
            </Grid>
            <Grid item xs={4}>
            ...
            <Grid item xs={4}>
              <Typography variant="body1"><strong>Mobile:</strong> {email.mobile ? email.mobile : "NA"}</Typography>
            </Grid>          
             </Grid>
          </Box>
    ...
    <td style={{ textAlign: "end", padding: "8px", border: "1px solid black" }}>
      {voucherHeads?.[voucher?.voucher_head_new_id]?.reduce(
          (total, sum) => Number(total) + Number(sum?.inr_value), 0)}
    </td>
  </tr>
))}
...
<tr style={{textAlign: "left"}}>
  ...
  <strong>{grandTotal}</strong>
          ...
          <Typography variant="body1"><strong>Transaction No.:</strong> {studentData?.transaction_no ?? "NA"}</Typography>
          <Typography variant="body1"><strong>Transaction Date:</strong> {studentData?.transaction_date
                 ? studentData?.transaction_date
                 : "NA"}</Typography>
          </Box>
          )}
           <Typography variant="body1"><strong>Remarks: </strong> {studentData?.remarks}</Typography>
