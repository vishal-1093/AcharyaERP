...
function EventUserCreationForm() {
  ...
  useEffect(() => {
    ...
    if (pathname.toLowerCase() === "/eventusermaster/events/user/new") {
      setIsNew(true);
      setCrumbs([
  ...
  const getEventData = async () => {
    await axios
      ...
      .then((res) => {
        ...
        setCrumbs([
          { name: "EventUserMaster", link: "/EventUserMaster/Events/User" },
          { name: "Event" },
          { name: "Update" },
        ]);
      })
            ...
            .then((res) => {
              ...
              if (
                ...
                axios
                  ...
                  .then((res) => {});
                navigate("/EventUserMaster/Events/User", { replace: true });
                setAlertMessage({
                  severity: "success",
...
export default EventUserCreationForm;
