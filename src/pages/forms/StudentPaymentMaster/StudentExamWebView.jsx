...
function StudentExamWebView() {
  ...
  return (
    ...
    >
      ...
      {/* Iframe */}
      <iframe
        src={`https://acharyainstitutes.in/index.php?r=admission/acerp-std-due-report/examfeepayment&auid_str=${encodeAuid}`}
        width="100%"
        height="1000px"
        style={{
          border: "none",
...
export default StudentExamWebView;
