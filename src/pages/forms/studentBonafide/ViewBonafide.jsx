                        ...
                        >
                          <Grid item xs={12} md={8}>
                            ...
                            >
                              ...
                              <br></br>
                              <Typography paragraph mt={1} ml={5}>
                                1. Student can pay all fees through Acharya ERP
                                APP.
                              </Typography>

                              <Typography paragraph ml={5}>
                                2. If student opts for Bank loan for DD can be
                                drawn in favor of “
                                <b>
                              ...
                              <Typography paragraph ml={5}>
                                3. If bank prefers to make RTGS Transfer, bank
                                can contact Institution via e-mail{" "}
                                <b>{`principal${(studentDetail?.school_name_short).toLowerCase()}@acharya.ac.in`}</b>{" "}
                                for bank details.
                              </Typography>

                              <Typography paragraph ml={5}>
                                4. DD can be drawn in favour of “ Nini Skillup
                                Pvt Ltd” for Add-on Programme Fee.
                              </Typography>

                              <Typography paragraph ml={5}>
                                5. Uniform & stationery to be paid through ERP
                                APP only, or at the fee counter.
                              </Typography>
                            </Typography>
                          </Grid>
                        </Grid>
