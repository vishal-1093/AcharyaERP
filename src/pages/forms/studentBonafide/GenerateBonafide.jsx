            ...
            "Provisional Bonafide" && (
              <Page size="A4" style={styles.body}>
                ...
                <View style={styles.topSection}>
                  <View style={{ ...styles.headerSection, marginTop: studentBonafideDetail?.length > 8 && bonafideAddOnDetail?.length > 0 ? "135px" : "150px" }}>
                ...
                <View style={{ ...styles.concernSection, marginTop: studentBonafideDetail?.length > 8 && bonafideAddOnDetail?.length > 0 ? "5px" : "10px" }}>
                  <View
                    style={{
                      width: "90%",
                      marginLeft: "15px",
                ...
                <View style={{ ...styles.studentDetailSection, marginTop: studentBonafideDetail?.length > 8 && bonafideAddOnDetail?.length > 0 ? "4px" : "20px" }}>
                ...
                <View>
                  <Text style={{ ...styles.amtText, marginTop: studentBonafideDetail?.length > 8 && bonafideAddOnDetail?.length > 0 ? "2px" : "8px" }}>{`(Amount in ${studentBonafideDetail[0]?.currency_type_name == "INR"
                      ? "Rupees"
                      : "USD"
                    })`}</Text>
                </View>
                ...
                {!!bonafideAddOnDetail[0]?.feeType && (
                  <View>
                    <Text style={{...styles.amtText,marginTop:studentBonafideDetail?.length > 8 &&  bonafideAddOnDetail?.length > 0 ? "2px":"8px" }}>{`(Amount in Rupees)`}</Text>
                  </View>
                )}
                {!!bonafideAddOnDetail[0]?.feeType && (
                  <View style={styles.feeTemplateSection}>
