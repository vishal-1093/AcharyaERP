          ...
          {studentBonafideDetail[0]?.bonafide_type ==
            "Provisional Bonafide" && (
              <Page size="a4" style={styles.body}>
                ...
                <View>
                  <Text style={styles.amtText}>{`(Amount in ${studentBonafideDetail[0]?.currency_type_name == "INR"
                      ? "Rupees"
                      : "USD"
                    })`}</Text>
                </View>
                ...
                <View style={styles.feeDetailSection}>
                  <View style={styles.sectionDetailWidth}>
                    <Image style={{ width: 100, height: 100 }} src={sign(`./${studentDetail?.school_name_short}.png`)} alt={studentDetail?.school_name_short} />
                    <Text
                      style={{
                        ...styles.feeDetailText,
                        ...styles.boldText
