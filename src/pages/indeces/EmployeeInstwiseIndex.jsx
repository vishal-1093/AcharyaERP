...
function EmployeeInstwiseIndex({ tab }) {
  ...
  const getData = async () => {
    await axios
      .get(
        `/api/employee/fetchAllEmployeeDetails?page=${0}&page_size=${10000}&sort=created_date&school_id=${schoolID}`
      )
      .then((res) => {
...
export default EmployeeInstwiseIndex;
