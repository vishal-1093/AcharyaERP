  ...
  const getData = async () => {
    try {
      const response = await axios.get(
        `/api/employee/getEmployeeDetailsDetailsDataBasedOnEmpId/${empID}`
      );
          ...
          >
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: "#f2f2f2" }}>
                  <TableCell align="center">
                    <strong>PHD Status</strong>
                  </TableCell>
                  <TableCell align="center">
                    <strong>UNIVERSITY THESIS</strong>
                  </TableCell>
                  <TableCell align="center">
              ...
              <TableBody>
                <TableRow>
                  <TableCell align="center">
                    {facultyDetails.phd_holder_pursuing || "-"}
                  </TableCell>{" "}
                  {/* Fixed */}
                  <TableCell align="center">
                    {facultyDetails.university_name || "-"}
                  </TableCell>{" "}
                  {/* Fixed */}
                  <TableCell align="center">
                    {facultyDetails.phd_register_date || "-"}
                  </TableCell>{" "}
                  {/* Fixed */}
                  <TableCell align="center">
                    {facultyDetails.phd_completed_date || "-"}
                  </TableCell>{" "}
                  {/* Fixed */}
                </TableRow>
              </TableBody>
          ...
          >
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: "#f2f2f2" }}>
                  <TableCell align="center">
                    <strong>Proctees</strong>
                  </TableCell>
                  <TableCell align="center">
                    <strong>Meetings held with students</strong>
                  </TableCell>
                  <TableCell align="center">
                    <strong>Meeting held with parent</strong>
                  </TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                <TableRow>
                  <TableCell align="center">
                    {facultyDetails.studentCount || "0"}
                  </TableCell>{" "}
                  {/* Fixed */}
                  <TableCell align="center">
                    {facultyDetails.studentCallCount || "0"}
                  </TableCell>{" "}
                  {/* Fixed */}
                  <TableCell align="center">
                    {facultyDetails.chief_proctor_id || "-"}
                  </TableCell>{" "}
                  {/* Fixed */}
                </TableRow>
              </TableBody>
            ...
            <Table>
              <TableHead>
                <TableRow sx={{ backgroundColor: "#f2f2f2" }}>
                  ...
                  <TableCell align="center">
                    <strong>Self Assessment Marks</strong>
                  </TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {[
                  ...
                  {
                    id: 2,
                    category: "PROFESSIONAL ACTIVITY AND/OR AWARDS",
                    maxMarks: 0,
                  },
          ...
          <FormControlLabel
            ...
            label={
              <Typography variant="body2">
                I hereby declare that all the data in the FARM is correct and
                agree that all my proctor personal details are up to date.
              </Typography>
            }
          />
        </Box>
