...
const EventForm = () => {
    ...
    const handleCreate = async () => {
        ...
        axios.post("/api/saveDailyPlanner", body)
            .then(res => {
                    ...
                    <Grid item xs={12} md={12} lg={6}>
                        ...
                        >
                            <Box sx={{ width: "100%" }}>
                                ...
                                />
                                {errors.eventTitle && <Typography variant="caption" sx={{ color: "red" }}>{errors.eventTitle}</Typography>}
                            </Box>
                            <Box sx={{ width: "100%" }}>
                                ...
                                />
                                <br></br>
                                {errors.startDate && <Typography variant="caption" sx={{ color: "red" }}>{errors.startDate}</Typography>}
                            </Box>
                            <Box sx={{ width: "100%" }}>
                                <CustomDateTimePicker
                                    name="endDate"
                                ...
                                />
                                <br></br>
                                {errors.endDate && <Typography variant="caption" sx={{ color: "red" }}>{errors.endDate}</Typography>}
                            </Box>
                            <Box sx={{ width: "100%" }}>
                                <CustomAutocomplete
                                    ...
                                    required
                                />
                                {errors.priority && <Typography variant="caption" sx={{ color: "red" }}>{errors.priority}</Typography>}
                            </Box>
                        </Grid>
                    </Grid>
                    <Grid item xs={12} md={12} lg={6}>
                        ...
                        >
                            <Box sx={{ width: "100%" }}>
                                <TextField
                                    ...
                                    onChange={handleChange}
                                />
                                {errors.description && <Typography variant="caption" sx={{ color: "red" }}>{errors.description}</Typography>}
                                <Box sx={{ textAlign: "right" }}>
                                    <Typography>{characterRemaining.current} Characters remaining</Typography>
                                </Box>
                            </Box>
                        </Grid>
                    </Grid>
