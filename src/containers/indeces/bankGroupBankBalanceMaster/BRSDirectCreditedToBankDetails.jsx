...
function BRSDirectCreditedToBankDetail() {
    ...
    const columns = [
        { field: "transaction_no", headerName: "Transaction No", flex: 1, headerClassName: "header-bg", headerAlign: 'center', align: 'center' },
        { field: "transaction", headerName: "Transaction", flex: 1, headerClassName: "header-bg", align: 'left', headerAlign: 'center' },
        { field: "cheque_dd_no", headerName: "Cheque DD No", flex: 1, headerClassName: "header-bg", align: 'left', headerAlign: 'center' },
