...
function BRSChqNotIssuedDebitedDetail() {
    ...
    const columns = [
        { field: "voucher_no", headerName: "Voucher No", flex: 1, headerClassName: "header-bg", headerAlign: 'center', align: 'center' },
        { field: "voucher_date", headerName: "Voucher Date", flex: 1, headerClassName: "header-bg", align: 'left', headerAlign: 'center' },
        { field: "pay_to", headerName: "Paid To", flex: 1, headerClassName: "header-bg", align: 'left', headerAlign: 'center' },
