...
export const RemarksForm = ({
  ...
  const handleCreate = async () => {
    if (!requiredFieldsValid()) {
      ...
      let payload = {
        studentId: studentId,
        studenIdCardHistoryId: studentDetail.student_id_card_history_id,
        validTill:studentDetail.valid_till,
        currentYear:studentDetail.current_sem,
        active: true,
        remarks: state.remarks,
        receiptDate: state.receiptDate,
        receiptNo: state.receiptNo,
      ...
      setLoading(true);
      await axios
        .post(`/api/student/studentDuplicateIdCardCreationWithHistory`, [
          payload,
        ])
        .then((res) => {
